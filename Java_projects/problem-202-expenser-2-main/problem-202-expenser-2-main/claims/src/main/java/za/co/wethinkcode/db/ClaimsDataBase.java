...
public class ClaimsDataBase implements ExpenseDB {
    private static final String CONN = "jdbc:sqlite:ClaimsDB.db";
    ...
    public void createDB() {
        String create = "CREATE TABLE IF NOT EXISTS Claims (\n"
                + " uid text,\n"
                + " expenseid text,\n"
                + " settleDate text\n"
                + " claim_amount number\n"
