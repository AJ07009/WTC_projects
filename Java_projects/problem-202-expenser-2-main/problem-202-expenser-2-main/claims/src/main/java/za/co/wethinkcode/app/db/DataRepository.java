package za.co.wethinkcode.app.db;

import com.google.common.collect.ImmutableList;
import za.co.wethinkcode.app.db.memory.MemoryDb;
...
import za.co.wethinkcode.app.model.Settlement;
 ...
 * is where data lives, without binding to any specific implementation like memory, file or ClaimsDataBase.
 * <p>
...
public interface DataRepository {
    ...
    /**
     * Remove a Person from the ClaimsDataBase. If you request removal of a Person that is not actually
     * in the ClaimsDataBase, your request will silently be ignored.
