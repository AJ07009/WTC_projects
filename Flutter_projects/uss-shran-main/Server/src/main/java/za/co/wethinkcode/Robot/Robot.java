...
public class Robot {
    private final ResponseBuilder robotResponse = new ResponseBuilder();
    private String name;
    ...
    public ResponseBuilder getRobotResponse(){
        return robotResponse;
    }

    public void setRobotResponse(Object response){
        this.robotResponse.addData(response);
    }
    ...
    public void kill(World world,  String message, Robot robot) {
        //Sets the robots shields to below 0.
        this.shields = -1;
        ...
        //Sends response to client and closes their thread.
        robot.setRobotResponse(response);
    }
