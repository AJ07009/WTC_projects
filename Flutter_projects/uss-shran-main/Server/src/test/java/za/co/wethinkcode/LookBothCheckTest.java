...
// MUST BE RUN WITH : java -jar reference-server-0.2.0.jar -p 5000 -s 10 -o 2,2

public class LookBothCheckTest {
    ...
    @Test
    void lookCommandWithRobotAndObs() {
...
//        assertEquals(2, response.get("state").get("position").get(1).asInt());
        ...
        System.out.println(lookObjects);
